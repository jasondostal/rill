...
export RILL_HOST=https://rill.example.com   # or http://localhost:8080
export RILL_TOKEN=rill_your_token_here

rill orient                                    # the rendered orient blob
rill recall "architecture decisions" --k 5
rill entities --type project
echo '{"kind":"decision","summary":"Deployed Rill to production",
       "project":"rill","author":"me"}' | rill remember
```

Memory tooling reaches full parity across the CLI, MCP, and REST surfaces —
